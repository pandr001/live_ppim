...
#myImg:hover {opacity: 0.7;}
  ...
  <figure>		
	<div class="dragArea" style="width:160px; height:160px;">
	 ...
	 <input type="file" name="imageContract" style="display:none;" id="image1">
     </div>
	</center>
	</div>
<figcaption>Contract</figcaption>
  ...
  <figure>		
	<div class="dragArea2" style="width:160px; height:160px;">
	 ...
	 <input type="file" name="imageProposed" style="display:none;" id="image2">
     </div>
	</center>
	</div>
<figcaption>Proposed Plan</figcaption>
  ...
  <figure>		
	<div class="dragArea3" style="width:160px; height:160px;">
	 ...
	 <input type="file" name="imageRoof" style="display:none;" id="image3">
     </div>
	</center>
	</div>
<figcaption>Roof Shot</figcaption>
  ...
  <figure>		
	<div class="dragArea4" style="width:160px; height:160px;">
	 ...
	 <input type="file" name="imageSwitch" style="display:none;" id="image4">
     </div>
	</center>
	</div>
<figcaption>Switch Board</figcaption>
  ...
  <figure>		
	<div class="dragArea5" style="width:160px; height:160px;">
	 ...
	 <input type="file" name="imageOther" style="display:none;" id="image5">
     </div>
	</center>
	</div>
